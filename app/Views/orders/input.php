                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-3">
                                    ...
                                    <select id="anggota" class="custom-select" name="pembeli" style="display: none;">
                                        <?php if (isset($order)) { ?>
                                            <option selected value=<?= $order[0]['id_pembeli']; ?>|<?= $order[0]['nama_pembeli']; ?>><?= $order[0]['nama_pembeli']; ?></option>
                                        <?php } else { ?>
                                    ...
                                    <input name="nonanggota" id="non_anggota" type="text" class="form-control" style="display: none;" placeholder="Input Non-Anggota">
                                </div>
                            </div>
                            <div class="row form-group">
                                <!-- <div class="col-2">
