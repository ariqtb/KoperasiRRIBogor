                    ...
                    <div class="card card-3">
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-3">
                                    <div class="mb-3">
                                        <select onchange="anggotaCheck(this);" class="custom-select">
                                            <option disabled selected value="">Jenis Pembeli</option>
                                    ...
                                    <?php
                                    // print_r($order);
                                    if ($order[0]['id_pembeli'] == 0) {
                                        $data_nama2 = $order;
                                        print_r($data_nama2[0]['nama_pembeli']);
                                    } else {
                                        $data_nama = $order;
                                    }
                                    ?>
                                    <select id="anggota" class="custom-select" name="pembeli" style="display: none;">
                                        <?php if (isset($data_nama)) { ?>
                                            <option selected value="<?= $data_nama[0]['id_pembeli']; ?>"><?= $data_nama[0]['nama_pembeli']; ?></option>
                                        <?php } else { ?>
                                            <option value="">Choose...</option>
                                        <?php } ?>
                                        <?php foreach ($pembeli as $pembeli) : ?>
                                            <option value="<?= $pembeli['id_pembeli']; ?>" name=""><?= $pembeli['nama_pembeli']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <?php
                                    if (isset($data_nama2)) { ?>
                                        <input name="nonanggota" id="non_anggota" value="<?= $data_nama2[0]['nama_pembeli']; ?>" type="text" class="form-control" style="display: none;" placeholder="Input Non-Anggota">
                                    <?php } else { ?>
                                        <input name="nonanggota" id="non_anggota" value="" type="text" class="form-control" style="display: none;" placeholder="Input Non-Anggota">
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-5">
                                    ...
                                    <a class="btn btn-sm btn-primary mt-3"><i class="fas fa-plus"></i> Tambah</a>
                                </div> -->
                                <div class="col-5">
                            ...
                            <div class="col-9">
                                <div class="table-responsive">
                                    <table class="table app-table-hover text-left" id="myTable">
                                        ...
                                        <tbody>
                                            <input hidden name="id_order" value="<?= $id ?>">
                                            <?php
                                            $i = 1;
                                            ...
                                            ?>
                                                <tr class="text-center" style="font-size: 12px;">
                                                    ...
                                                    <td class="cell">
                                                        <a class="btn-sm app-btn-secondary" href="<?= base_url('Orders/clearPerItem/' . $value['rowid']); ?>"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                    <?php $i++; ?>
                                                </tr>
                                            <?php endforeach; ?>
                                ...
                                <div class=" row justify-content-between m-3">
                                    <div class="col-auto">
                                        ...
                                        <a href="<?= base_url('Orders/clear') ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                    </div>
                                    <div class="col-auto">
                                        <!-- <a href="<?= base_url('Orders/saveupdate/' . $id) ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a> -->
                                        <button type="submit" name="action" value="saveupdate" class="btn btn-sm btn-success">Simpan</button>
                                    </div>
                                </div>
                                <?= form_close() ?>
                            </div>
...
<div class="modal fade show" id="baranginput" tabindex="-1" aria-labelledby="inputlabel" aria-hidden="true">
                            ...
                            ?>
                                    <tr class="text-center">
                                        ...
                                        <td class="cell">
                                            ...
                                            <a class="btn btn-sm btn-success " href="<?= base_url('Orders/add/' . $items['id_item']); ?>"><i class="fas fa-plus"></i></a>
                                        </td>
                                        <?php $i++; ?>
                                <?php }
                            endforeach; ?>
...
<script type="text/javascript">
    ...
    function anggotaCheck(that) {
        if (that.value == "anggota") {
            document.getElementById("anggota").style.display = "block";
            document.getElementById("non_anggota").style.display = "none";
        } else {
            document.getElementById("anggota").style.display = "none";
            document.getElementById("non_anggota").style.display = "block";
        }
    }
</script>